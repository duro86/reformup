        ...
        <div class="row justify-content-center align-items-start">
            ...
            <div class="col-lg-7 bg-white shadow rounded p-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="cif" name="cif" value="{{ old('cif') }}" class="form-control @error('cif') is-invalid @enderror" required>
                    @error('cif')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    <label class="form-label" for="email_empresa">Email de la empresa <span class="text-danger">*</span></label>
                    <input type="email" id="email_empresa" name="email_empresa" value="{{ old('email_empresa') }}" class="form-control @error('email_empresa') is-invalid @enderror" required>
                    @error('email_empresa')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea id="bio" name="bio" class="form-control @error('bio') is-invalid @enderror" rows="3" style="resize: none;">{{ old('bio') }}</textarea>
                    @error('bio')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="url" id="web" name="web" value="{{ old('web') }}" class="form-control @error('web') is-invalid @enderror">
                ...
                <div class="mb-3">
                    <label class="form-label" for="telefono_empresa">Teléfono de la empresa <span class="text-danger">*</span></label>
                    <input type="text" id="telefono_empresa" name="telefono_empresa" value="{{ old('telefono_empresa') }}" class="form-control @error('telefono_empresa') is-invalid @enderror" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="ciudad_empresa" name="ciudad_empresa" value="{{ old('ciudad_empresa') }}" class="form-control @error('ciudad_empresa') is-invalid @enderror">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="provincia_empresa" name="provincia_empresa" value="{{ old('provincia_empresa') }}" class="form-control @error('provincia_empresa') is-invalid @enderror">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="direccion_empresa" name="direccion_empresa" value="{{ old('direccion_empresa') }}" class="form-control @error('direccion_empresa') is-invalid @enderror" placeholder="Avd/Cabezo de la Joya 3, escalera 3, 4ºA">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" id="avatar_empresa" name="avatar_empresa" accept="image/*" class="form-control @error('avatar_empresa') is-invalid @enderror">
