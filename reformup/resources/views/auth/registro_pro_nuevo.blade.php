            ...
            <div class="col-lg-6 bg-white shadow rounded p-5">
                ...
                <form method="POST" action="{{ route('registrar.profesional') }}" novalidate enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label" for="password_confirmation">Confirma Contraseña <span
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="telefono" name="telefono" value="{{ old('telefono') }}"
                                placeholder="612345678" class="form-control @error('telefono') is-invalid @enderror"
                                required>
                            @error('telefono')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="cp" name="cp" placeholder="21004" maxlength="5"
                                value="{{ old('cp') }}" class="form-control @error('cp') is-invalid @enderror">
                            @error('cp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="direccion" name="direccion"
                            placeholder="Avd/Cabezo de la Joya 3, escalera 3, 4ºA" value="{{ old('direccion') }}"
