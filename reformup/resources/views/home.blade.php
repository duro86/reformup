...
@section('content')
  ...
  <section class="hero text-center">
    <div class="overlay"></div>
      <div class="container hero-content text-center">
        <h1 class="display-5 fw-bold text-white">Encuentra Profesionales de Confianza<br>para tu <span class="text-warning">Reforma</span></h1>
      ...
      <div class="d-flex justify-content-center gap-3">
          ...
          <a href="{{ route('registrar.profesional') }}" class="btn btn-outline-light btn-lg">Registrarte como Profesional</a>
      </div>
  ...
  <section class="py-5 bg-light" id="profesionales-destacados">
    <div class="container">
      ...
      <p class="text-center text-muted mb-5">Profesionales mejor valorados del mes <i class="bi bi-trophy-fill"></i></p>

      <div class="row g-4">
        @php
          $profesionalesPrueba = [
            ['nombre' => 'Ana Pérez', 'rating' => 5.0, 'resenas' => 20, 'ciudad' => 'Madrid', 'oficios' => ['Electricista', 'Fontanero']],
            ['nombre' => 'Luis Gómez', 'rating' => 4.8, 'resenas' => 15, 'ciudad' => 'Barcelona', 'oficios' => ['Albañil']],
            ['nombre' => 'Marta Ruiz', 'rating' => 4.9, 'resenas' => 30, 'ciudad' => 'Valencia', 'oficios' => ['Cerrajero', 'Jardinero']],
            ['nombre' => 'Carlos Flores', 'rating' => 5.0, 'resenas' => 12, 'ciudad' => 'Sevilla', 'oficios' => ['Pintor']],
            ['nombre' => 'Laura Díaz', 'rating' => 4.7, 'resenas' => 28, 'ciudad' => 'Bilbao', 'oficios' => ['Carpintero']],
            ['nombre' => 'Javier Sánchez', 'rating' => 4.6, 'resenas' => 18, 'ciudad' => 'Granada', 'oficios' => ['Electricista']],
            ['nombre' => 'Sandra Molina', 'rating' => 4.9, 'resenas' => 24, 'ciudad' => 'Zaragoza', 'oficios' => ['Fontanero']],
            ['nombre' => 'Pedro López', 'rating' => 5.0, 'resenas' => 22, 'ciudad' => 'Málaga', 'oficios' => ['Albañil', 'Pintor']],
          ];
        @endphp
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="card h-100 shadow-sm card-pro">
              <div class="d-flex align-items-center p-3">
                <img class="rounded-circle me-3" src="/img/pro_card.jpg" alt="Foto {{ $p['nombre'] }}" width="60" height="60">
              ...
              <div class="card-body">
                <div class="d-flex align-items-center mb-2">
                  ...
                  <small class="text-muted">({{ number_format($p['rating'],1) }}) - {{ $p['resenas'] }} reseñas</small>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3 d-flex flex-wrap gap-2">
                  @foreach($p['oficios'] as $o)
                    <span class="badge bg-light text-dark rounded-pill px-3 py-1">{{ $o }}</span>
                  @endforeach
                </div>
              </div>
                    ...
                    <div class="card-body p-4">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="text-nowrap">
                          ...
                          <span class="fw-semibold ms-1">{{ number_format($c['estrellas'],1) }}</span>
                        </div>
                      </div>
                    </div>
                  </article>
