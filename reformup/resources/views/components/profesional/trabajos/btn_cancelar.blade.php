...
<form id="form-cancelar-trabajo-pro-{{ $trabajo->id }}" action="{{ route('profesional.trabajos.cancelar', $trabajo) }}"
    ...
    <button type="button" id="btn-cancelar-trabajo-pro-{{ $trabajo->id }}"
