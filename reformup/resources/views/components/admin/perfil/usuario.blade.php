...
{{-- Fila 1  Email · Provincia · Municipio --}}
<div class="row">
    <div class="col-md-4 mb-3">
...
<x-ciudadProvincia.ciudades_provincias provincia-id="provincia_user" ciudad-id="ciudad_user" :oldProvincia="old('provincia_user', $usuario->provincia)"
    :oldCiudad="old('ciudad_user', $usuario->ciudad)" />
