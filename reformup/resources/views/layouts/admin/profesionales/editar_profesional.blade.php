        ...
        <div class="row g-0 shadow rounded overflow-hidden">
            ...
            <div class="col-lg-7 bg-white">
                <div class="p-4 p-lg-5">
                    ...
                    <form method="POST"
                          action="{{ route('admin.profesionales.actualizar', $perfil->id) }}"
                          novalidate
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       name="ciudad"
                                       value="{{ old('ciudad', $perfil->ciudad) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       name="provincia"
                                       value="{{ old('provincia', $perfil->provincia) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input"
                                       ...
                                       id="visible_si"
                                       value="1"
                                       {{ old('visible', $perfil->visible) ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input"
                                       ...
                                       id="visible_no"
                                       value="0"
                                       {{ old('visible', $perfil->visible) == 0 ? 'checked' : '' }}>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.profesionales') }}" class="btn btn-outline-secondary">
                                Cancelar
                            </a>
                        </div>
